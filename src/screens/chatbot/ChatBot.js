...
import { Dimensions, Keyboard, TextInput, ScrollView, Platform, Text, TouchableOpacity, View, KeyboardAvoidingView } from 'react-native';
...
class ChatBot extends Component {
  ...
  render() {
    ...
    const inputAttributesOverride = currentStep ? currentStep?.inputAttributes || inputAttributes : inputAttributes;
    ...
    return (
      <View>
        <ChatBotContainer
          ...
          {!this.props.hideFooter && <InputView
